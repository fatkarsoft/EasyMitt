          ...
          {loading === "load" ? <div className="text-muted">{t(language, "loading")}...</div> : (
            <>
              <div className="balanced-form-grid">
                ...
                <Field span="span-3" label={t(language, "category")}><input className="form-control" value={form.category || ""} onChange={(e) => set(form, setForm, "category", e.target.value)} /></Field>
                ...
                <Field span="span-3" label={t(language, "datevCreditorAccount")}><input className="form-control" value={form.datevCreditorAccount || ""} onChange={(e) => set(form, setForm, "datevCreditorAccount", e.target.value)} placeholder="70001" /></Field>
